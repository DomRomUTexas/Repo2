...
m
as.data.frame(m)
# STOP- rest of this challenge is incomplete!!!!! not sure how to these 3: As a data frame, coerce the second column to be logical-valued (Boolean) As a data frame, coerce the third column to be factor-valued When you are done, use the str() command to show the data type for each variable in your dataframe.
